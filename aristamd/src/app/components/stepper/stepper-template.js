export default function importStepperTemplates($templateCache) {
      $templateCache.put('stepper-step1.html', '<div class="app__stepper-body" ng-if="true">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry'+
